# Community Chest
## Local social networking for local projects

## Installation

This project is based on [https://github.com/airbnb/rendr-app-template](airbnb/rendr-app-template v0.2.1) so installation is similar:
